...
export function EmailsScreen() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold tracking-tight text-gradient">Email Manager</h1>
      ...
      <Tabs id="email-manager-tabs" defaultValue="templates" className="space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Card>
              <CardHeader>
                <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                  <div>
                    <CardTitle className="text-sm font-medium">Inactivity Nudge <InfoTip text="Manual trigger only. Click Preview to see users who haven't signed in for X days, then Send to email them. Tip: Run this weekly to re-engage dormant users." /></CardTitle>
            ...
            <Card>
              <CardHeader>
                <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                  <div>
                    <CardTitle className="text-sm font-medium">Milestone Celebration <InfoTip text="Manual trigger only. Preview shows users who applied to X+ jobs this month. Send to congratulate them. Tip: Run at the end of each month to celebrate active users." /></CardTitle>
        ...
        <TabsContent value="profile-reminders">
          <Card>
            <CardHeader>
              <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                <div>
                  <CardTitle className="text-sm font-medium">Incomplete Profiles <InfoTip text="Manual trigger only. Preview shows users with less than 80% profile completion and what fields are missing. Send to nudge them to complete their profile. Tip: Run this a few days after a wave of new signups." /></CardTitle>
        ...
        <TabsContent value="settings">
          <Card>
            <CardHeader>
              <CardTitle className="text-sm font-medium">SMTP Configuration <InfoTip text="Your Gmail SMTP credentials are set via environment variables. The test email button sends a sample email to verify everything is working." /></CardTitle>
